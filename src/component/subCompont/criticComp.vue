...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getComment() {
        this.$http
          .get('http://127.0.0.1:5000/comment_list?id='+ this.id + '&pages='+ this.pageIndex)
      ...
      puplishCri() {
        ...
        //发起请求
        this.$http
          .post('http://127.0.0.1:5000/news_cri', {news_id: this.id, content: this.msg})
          .then(function (result) {
